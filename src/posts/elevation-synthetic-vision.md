...
{{ imgctl.centerImage('elevation-synthetic-vision-1.jpg', caption = 'Mt. Rainier from Mapbox Satellite with elevation' ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-2.jpg', caption = 'Level 0 loaded', content = loadingPara ) }}
...
{{ imgctl.centerImage('elevation-synthetic-vision-3.png' ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-4.jpg', caption = 'Saildrone Forecast uses a hybrid vector map on a globe', content = paragraph ) }}
...
{{ imgctl.centerImage('elevation-synthetic-vision-5.jpg', caption = 'Super complex diagram of the render pipeline' ) }}
...
{{ imgctl.centerImage('elevation-synthetic-vision-6.png' ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-7.jpg', caption = 'Geometry Tile Points to Elevation and Imagery Pools', content = paragraph ) }}
...
{{ imgctl.centerImage('elevation-synthetic-vision-8.jpg', caption = 'Elevation + Runway = Flattened Elevation' ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-9.jpg', content = paragraph ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-10.jpg', caption='Objects sitting on top of terrain', content = paragraph ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-11.jpg', caption='Tiles with St. Helens take up more screen space', content = paragraph ) }}
...
{{ imgctl.leftImage('elevation-synthetic-vision-12.jpg', content = paragraph ) }}
